package com.example.medicine.seakleave.adapter;
...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.ViewHolder> {
    ...
    public void setRVSAdapter(List<MiniCard> miniCards, SeakLeaveCardsView seakLeaveCardsView) {
        ...
        holder.enterBigInformation.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        seakLeaveCardsView.setActivity(miniCard.getIdCard(),miniCard.getIdThis());
                    }
                });
    }

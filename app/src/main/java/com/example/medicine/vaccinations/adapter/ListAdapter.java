package com.example.medicine.vaccinations.adapter;
...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.ViewHolder> {
    ...
    public void setRVSAdapter(List<MiniCard> miniCards, VaccinationCardsView vaccinationCardsView) {
        ...
        holder.enterBigInformation.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        vaccinationCardsView.setActivity(miniCard.getIdCard(),miniCard.getIdThis());
                    }
                });
    }
